		...
		<div class="wrap">
			...
			<div class="top-nav">
				<ul>
					...
					<li class="active1"><a href="${pageContext.request.contextPath}/jazz.jsp">Jazz</a></li>
...
<%
        ...
        try{
			...
			PreparedStatement ps1 = conn.prepareStatement("SELECT * FROM jazz "); 
			rs = ps1.executeQuery();
			while(rs.next()){
...
%>
						...
						<!--  
							<div class="grid_1_of_5 images_1_of_5">
								 <img src="${pageContext.request.contextPath}/images/something.png">
								 <h3>Something Just Like this</h3>
								 <h4>Rs. 99.00</h4>
								 <button class="button" style="vertical-align:middle"><span>BUY THIS </span></button>
						   </div>
							<div class="grid_1_of_5 images_1_of_5">
								 <img src="${pageContext.request.contextPath}/images/paradise.jpg">
								 <h3> Coldplay Paradise</h3>
								<h4>Rs. 99.00</h4>
								<button class="button" style="vertical-align:middle"><span>BUY THIS </span></button>
						    </div>
							<div class="grid_1_of_5 images_1_of_5">
								<img src="${pageContext.request.contextPath}/images/cold.jpg">
								 <h3> Cold Water </h3>
								 <h4>Rs. 120.00</h4>
								 <button class="button" style="vertical-align:middle"><span>BUY THIS </span></button>
							</div>
							<div class="grid_1_of_5 images_1_of_5">
								 <img src="${pageContext.request.contextPath}/images/allwe.jpg">
								 <h3> Chainsmokers-All We Know </h3>
								 <h4>Rs. 200.00</h4>
<button class="button" style="vertical-align:middle"><span>BUY THIS </span></button>
							</div>
							<div class="grid_1_of_5 images_1_of_5">
								 <img src="${pageContext.request.contextPath}/images/ofyou.jpg">
								 <h3>Shape Of You- Ed Sheeran</h3>
								 <h4>Rs. 120.00</h4>
<button class="button" style="vertical-align:middle"><span>BUY THIS </span></button>
							</div>
