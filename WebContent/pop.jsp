		...
		<div class="wrap">
			...
			<div class="top-nav">
				<ul>
					...
					<li class="active1"><a href="${pageContext.request.contextPath}/pop.jsp">Pop</a></li>
...
<button class="button" style="vertical-align:middle"><span>BUY THIS </span></button>
							...
							<div class="grid_1_of_5 images_1_of_5">
								 <img src="${pageContext.request.contextPath}/images/came.jpg">
								 <h3> This is What you Came for by Calvi Harris</h3>
								<h4>Rs. 49.00</h4>
<button class="button" style="vertical-align:middle"><span>BUY THIS </span></button>
						    </div>
							<div class="grid_1_of_5 images_1_of_5">
								<img src="${pageContext.request.contextPath}/images/cheap.jpg">
								 <h3>Cheap Thrills by Sia  </h3>
								 <h4>Rs. 120.00</h4>
<button class="button" style="vertical-align:middle"><span>BUY THIS </span></button>
							</div>
							<div class="grid_1_of_5 images_1_of_5">
								 <img src="${pageContext.request.contextPath}/images/live.jpg">
								 <h3>One Direction-Live While We're Young </h3>
								 <h4>Rs. 200.00</h4>
<button class="button" style="vertical-align:middle"><span>BUY THIS </span></button>
							</div>
							<div class="grid_1_of_5 images_1_of_5">
								 <img src="${pageContext.request.contextPath}/images/whatm.jpg">
